...
public class NeoBiomeManage
{
    private float Zoom = 0.3f;
    private FastNoiseLite BiomeNoise = new FastNoiseLite();

    private List<LandBiome> LandBiomes = new List<LandBiome>();
    private List<BiomeItem> MixinLandbiomes = new List<BiomeItem>();
    private List<Biome> DeepBiomes = new List<Biome>();
    private List<Biome> SkyBiomes = new List<Biome>();
    private float LandMaxWeight = 0;
    private float MixinLandMaxWeight = 0;
    private float DeepMaxWeight = 0;
    private float SkyMaxWeight = 0;

    /// <summary>
    /// 注册生物群系
    /// </summary>
    /// <param name="basebiome">群系类型</param>
    private void Register(BaseBiome basebiome)
    {
    ...
    /// <returns></returns>
    public LandBiome GetLandBiome(string name)
    {
    ...
    private void MixinBiomes(Random random, int time)
    {
    ...
    /// <param name="y"></param>
    /// <returns></returns>
    public BiomeType CheckRange(int[,] HighMap, int x, int y)
    {
        int gx = Chunk.Size * x;
        int gy = Chunk.Size * y;
        int IsDeep = 0;
    ...
    /// <returns></returns>
    public LandBiome GetMixinLandBiome(int x)
    {
    ...
    /// <param name="y"></param>
    /// <returns></returns>
    public Biome GetDeepBiome(int x, int y)
    {
    ...
    /// <param name="y"></param>
    /// <returns></returns>
    public Biome GetSkyBiome(int x, int y)
    {
    ...
    public BaseBiome GetBiomeAsName(string name)
    {

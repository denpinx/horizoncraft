...
//                 float p0 = BiomeManage.GetMixinLandBiome(x - 1)
//                     .GetHigh(new Random((int)(World.Seed + x - 1)), FastNoiseLite, x - 1, z);
//                 float p1 = BiomeManage.GetMixinLandBiome(x).GetHigh(new Random((int)(World.Seed + x)), FastNoiseLite, x, z);
//                 float p2 = BiomeManage.GetMixinLandBiome(x + 1)
//                     .GetHigh(new Random((int)(World.Seed + x + 1)), FastNoiseLite, x + 1, z);
//                 float p3 = BiomeManage.GetMixinLandBiome(x + 2)
...
//         {
//             LandBiome landbiome = BiomeManage.GetMixinLandBiome(x);
